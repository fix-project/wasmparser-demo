...
static u32 w2c_iris_add_0(w2c_iris*, u32, u32);
static u32 w2c_iris_sub(w2c_iris*, u32, u32);
static f64 w2c_iris_square(w2c_iris*, f64);
static void w2c_iris_noop(w2c_iris*);
static u32 w2c_iris_sum_of_squares_0(w2c_iris*, u32, u32);
static f64 w2c_iris_mixed_locals(w2c_iris*, u32);
static void w2c_iris_add_and_log(w2c_iris*, u32, u32);

FUNC_TYPE_T(w2c_iris_t0) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_iris_t1) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_iris_t2) = "\x0a\xb9\x50\x3c\x6a\xf0\x79\x2e\x9c\x53\x4a\xd4\xf1\x68\x37\xd4\xe0\xdf\x32\xf6\x00\xb4\x45\xdf\x75\x1e\xd7\x52\xa6\x86\xd7\xac";
FUNC_TYPE_T(w2c_iris_t3) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_iris_t4) = "\x3d\x0f\x16\xf6\x24\x19\x30\xd2\xbf\x7c\x25\x94\xb5\xdf\x90\x3d\x74\x62\xde\x34\x41\x83\xb0\xaf\x1a\xd8\x82\x63\xdc\xdf\xfe\x21";
FUNC_TYPE_T(w2c_iris_t5) = "\x26\x10\x81\xe2\x21\x43\xd6\x01\x3e\x2d\x2f\x16\x17\x78\x6f\xba\xb3\x2f\x4d\x54\x9b\x8a\xa9\xdd\xbf\x53\x92\x3c\xd3\x71\xc6\xb2";

/* export: 'add' */
u32 w2c_iris_add(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  u32 ret = w2c_iris_add_0(instance, var_p0, var_p1);
  return ret;
}

/* export: 'sum_of_squares' */
u32 w2c_iris_sum_of_squares(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  u32 ret = w2c_iris_sum_of_squares_0(instance, var_p0, var_p1);
  return ret;
}

static void init_instance_import(w2c_iris* instance, struct w2c_env* w2c_env_instance) {
  instance->w2c_env_instance = w2c_env_instance;
}

void wasm2c_iris_instantiate(w2c_iris* instance, struct w2c_env* w2c_env_instance) {
  assert(wasm_rt_is_initialized());
  init_instance_import(instance, w2c_env_instance);
}

void wasm2c_iris_free(w2c_iris* instance) {
}
...
wasm_rt_func_type_t wasm2c_iris_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  ...
  if (param_count == 1 && result_count == 1) {
    va_start(args, result_count);
    if (true && va_arg(args, int) == WASM_RT_F64 && va_arg(args, int) == WASM_RT_F64) {
      va_end(args);
      return w2c_iris_t2;
    }
    va_end(args);
  ...
  if (param_count == 1 && result_count == 1) {
    va_start(args, result_count);
    if (true && va_arg(args, int) == WASM_RT_I32 && va_arg(args, int) == WASM_RT_F64) {
      va_end(args);
      return w2c_iris_t4;
    }
    va_end(args);
...
u32 w2c_iris_add_0(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  u32 var_l2 = 0, var_l4 = 0;
  u64 var_l3 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = var_p0;
...
u32 w2c_iris_sub(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = var_p0;
  var_i1 = var_p1;
...
f64 w2c_iris_square(w2c_iris* instance, f64 var_p0) {
  FUNC_PROLOGUE;
  f64 var_d0, var_d1;
  var_d0 = var_p0;
  var_d1 = var_p0;
...
void w2c_iris_noop(w2c_iris* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

u32 w2c_iris_sum_of_squares_0(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  u32 var_a_squared = 0, var_b_squared = 0, var_total = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = var_p0;
  var_i1 = var_p0;
  var_i0 *= var_i1;
  var_a_squared = var_i0;
  var_i0 = var_p1;
  var_i1 = var_p1;
  var_i0 *= var_i1;
  var_b_squared = var_i0;
  var_i0 = var_a_squared;
  var_i1 = var_b_squared;
  var_i0 += var_i1;
  var_total = var_i0;
  var_i0 = var_total;
  FUNC_EPILOGUE;
...
f64 w2c_iris_mixed_locals(w2c_iris* instance, u32 var_p0) {
...
void w2c_iris_add_and_log(w2c_iris* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = var_p0;
  var_i1 = var_p1;
  var_i0 = w2c_iris_add_0(instance, var_i0, var_i1);
